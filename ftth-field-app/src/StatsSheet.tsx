...
import { extractNapClients } from './FieldMapView'
...
function computeStats(subProject: SubProject) {
  ...
  const napCritical = napFeatures
    .map(f => ({
      ...
      critCount: extractNapClients(f).filter(c => c.powerStatus === 'crit').length,
    }))
      ...
      <div className="nap-sheet">
        ...
        <div className="sheet-header">
          <div className="sheet-header-main">
            <div>
              <div className="sheet-title">Estadísticas</div>
        ...
        <div className="sheet-body">
          ...
          {napCritical.length > 0 && (
            <>
              <div className="stats-section-title" style={{ marginTop: 20 }}>
                NAPs con clientes críticos
              </div>
          ...
          {napCritical.length === 0 && clientCount > 0 && (
            <div className="state-msg" style={{ padding: '16px 16px 0' }}>
              No hay clientes en estado crítico.
            </div>
          )}
        </div>
      </div>
