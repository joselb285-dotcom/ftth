...
export default function FieldView({
  ...
  onUpdateNotes, onToggleSurveyMode, onStartAddPole, onSearch, onGoBack, onShowStats,
}: Props) {
    ...
    <aside className={`fv-sidebar${mobExpanded ? ' mob-exp' : ''}`}>
      ...
      <div className="fv-mob-top">
        ...
        {selectedFeature && p ? (
          ...
          <>
          <div className="fv-mob-empty-hint">
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
              <circle cx="11" cy="11" r="8"/><path d="M21 21l-4.35-4.35"/>
            </svg>
            <span>Tocá un elemento del mapa para inspeccionarlo</span>
          </div>
          <div className="fv-mob-quick-btns">
            <button className="fv-mob-btn fv-mob-btn-sec" onClick={onSearch}>
              <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
                <circle cx="11" cy="11" r="8"/><path d="M21 21l-4.35-4.35"/>
              </svg>
              Buscar cliente / elemento
            </button>
            {onShowStats && (
              <button className="fv-mob-btn fv-mob-btn-sec" onClick={onShowStats}>
                <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
