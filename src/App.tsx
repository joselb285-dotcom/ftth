...
import MemoriaDescriptivaModal, { generateUnifilarPdf, generatePresupuestoPdf, generatePlanillaPdf } from './MemoriaDescriptivaModal'
      ...
      <header className="topbar">
        ...
        <div className="topbar-right">
          ...
          <DropdownMenu label="Acciones">
            ...
            <button className="dropdown-item" disabled={!proj.currentSubProject} onClick={() => proj.currentSubProject && generateUnifilarPdf(proj.currentSubProject, proj.currentProject?.name ?? '')}>
              <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                <rect x="3" y="3" width="18" height="18" rx="2"/><line x1="12" y1="3" x2="12" y2="21"/>
                <line x1="3" y1="9" x2="21" y2="9"/><circle cx="8" cy="16" r="1.5" fill="currentColor"/>
              </svg>
              Diagrama unifilar óptico
            </button>
            <button className="dropdown-item" disabled={!proj.currentSubProject} onClick={() => proj.currentSubProject && generatePresupuestoPdf(proj.currentSubProject, proj.currentProject?.name ?? '')}>
              <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                <path d="M14 2H6a2 2 0 00-2 2v16a2 2 0 002 2h12a2 2 0 002-2V8z"/>
                <polyline points="14 2 14 8 20 8"/>
            ...
            <button className="dropdown-item" disabled={!proj.currentSubProject} onClick={() => proj.currentSubProject && generatePlanillaPdf(proj.currentSubProject, proj.currentProject?.name ?? '')}>
              <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
